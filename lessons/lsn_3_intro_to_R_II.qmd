...
2. Write a custom function and apply it across grouped data.
...
-   Using the `Teams` data frame, calculate win % for each MLB team from 2000-present. Order your results from the best teams to the worst.
...
HRLeaders |> 
  ...
  kable(caption = "Major League HR leaders by season.")
```

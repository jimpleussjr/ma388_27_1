...
2. Interpret regression coefficients assess model fit using residual plots.
3. Determine the number of wins typically needed to make the playoffs using historical data.

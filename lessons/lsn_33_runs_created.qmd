...
1. Compute the Basic, Stolen Base, and Technical versions of Runs Created from Lahman data.
2. Diagnose data coverage limitations across baseball history for each Runs Created formula.
3. Compute runs-created rate per game and use the Pythagorean formula to estimate a player's win percentage.
4. Use Runs Created to answer "Who is the best batter in history?" and "Which team had the greatest lineup?"

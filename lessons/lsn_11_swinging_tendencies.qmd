...
1. Use regular expressions and stringr functions to process pitch sequence data.
2. Create indicator variables for whether a plate appearance passed through each ball-strike count.
3. Compute and visualize the mean run value for each count.
4. Explain why ball-strike count affects expected run value.

...
1. Calculate OPS+ to compare batters across different offensive eras.
2. Explain why raw OPS is not appropriate for cross-era comparisons and how OPS+ adjusts for league context.
3. Compute Isolated Power (ISO) to distinguish between different types of hitters.
4. Calculate BABIP and explain what it communicates about a player's performance on balls in play.

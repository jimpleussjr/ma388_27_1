...
1. Use `ggplot` with aesthetic mappings to visualize data.
2. Transform data between wide and long format and understand when to use which.

## Henry ("Hank") Aaron (1934-2021)

![Henry Aaron (Source: *New York Times*)](aaron.png){width="50%"}

[PBS News Hour | A look back at the life of baseball legend Hank Aaron](https://www.pbs.org/video/hank-aaron-1611353659/)

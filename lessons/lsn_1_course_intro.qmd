...
1.  Identify major baseball data sources (Lahman, Retrosheet, PITCHf/x, Statcast) and their appropriate use cases.
2.  Explore data using basic tidyverse verbs (select, filter, mutate, group_by, summarize, arrange).
